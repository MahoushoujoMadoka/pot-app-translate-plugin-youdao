async function translate(text, from, to, options) {
  ...
  form.append("sign", CryptoJS.MD5(`client=fanyideskweb&mysticTime=${mysticTime}&product=webfanyi&key=SRz6r3IGA6lj9i5zW0OYqgVZOtLDQe3e`).toString(CryptoJS.enc.Hex));
